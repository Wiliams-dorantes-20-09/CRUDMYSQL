...
namespace CRUDMYSQL
{
    public partial class registrerDetergent : Form
    {
        public registrerDetergent()
        {
            InitializeComponent();
            LoadTable(null);
        }

        private void registrerDetergent_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT id, codigo, nombre, descripcion, precio_publico, existencias FROM detergent WHERE codigo LIKE '" + code + "' LIMIT 1";
        ...
        private void LoadTable(string data)
        {
            ...
            dataGridView1.DataSource = ctl.queryDetergent(data);
        }
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (codigo != "" && nombre != "" && descripcion != "" && precio_publico > 0 && existencias > 0)
                {
                    ...
                    string sql = "START TRANSACTION; INSERT INTO detergent (codigo, nombre, descripcion, precio_publico, existencias) " +
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            string sql = "START TRANSACTION; UPDATE detergent SET codigo='" + codigo + "', nombre='" + nombre + "', descripcion='" + descripcion
        ...
        private void iconButton4_Click(object sender, EventArgs e)
        {
            ...
            string sql = "START TRANSACTION; DELETE FROM detergent WHERE id='" + id + "'; commit;";
        ...
        {
             triggerDetergent td = new triggerDetergent();
            td.Visible = true;
            this.Visible = false;
        }
